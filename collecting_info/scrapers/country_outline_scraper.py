...
def process_country(feature, target_countries):
    ...
    # Return path relative to project root (where game.html is located)
    return matched_name, f"collecting_info/data/countries/{png_path.name}"
